 ...
 */
    return array(
        'MENUS' => array(
            ...
            array(
                'group' => array('title'=>'会员管理','icon'=>'fa fa-user fa-fw','class'=>'','url'=>'Member/index','is_developer'=>0),
                '_child' => array(
                )
            ),
            array(
            ...
            array(
                ...
                '_child' => array(
                    ...
                    array('title'=>'专场','url'=>'SpecialStage/index','class'=>'','is_developer'=>0),
                )
            ),
            array(
                'group' => array('title'=>'红包管理','icon'=>'fa fa-navicon','class'=>'','url'=>'javascript:void(0);','is_developer'=>0),
                '_child' => array(
                    array('title'=>'新人红包配置','url'=>'NewBag/index','class'=>'','is_developer'=>0),
                    array('title'=>'新人红包记录','url'=>'NewBagLog/index','class'=>'','is_developer'=>0),
                )
            ),
            array(
                'group' => array('title'=>'签到管理','icon'=>'fa fa-calendar-check-o','class'=>'','url'=>'javascript:void(0);','is_developer'=>0),
                '_child' => array(
                    array('title'=>'签到配置','url'=>'Check/update?id=1','class'=>'','is_developer'=>0),
                    array('title'=>'签到记录','url'=>'CheckLog/index','class'=>'','is_developer'=>0),
                )
            ),
            array(
                'group' => array('title'=>'抽奖管理','icon'=>'fa fa-unlock','class'=>'','url'=>'javascript:void(0);','is_developer'=>0),
                '_child' => array(
                    array('title'=>'抽奖配置','url'=>'Lottery/update?id=1','class'=>'','is_developer'=>0),
                    array('title'=>'抽奖记录','url'=>'LotteryLog/index','class'=>'','is_developer'=>0),
                )
            ),
            array(
                'group' => array('title'=>'财务管理','icon'=>'fa fa-money','class'=>'','url'=>'javascript:void(0);','is_developer'=>0),
                '_child' => array(
                    array('title'=>'用户提现','url'=>'Withdraw/index','class'=>'','is_developer'=>0),
                    array('title'=>'她他币记录','url'=>'PlatformCurrencyLog/index','class'=>'','is_developer'=>0),
                )
            ),
            array(
